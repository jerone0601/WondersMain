 ...
 */
public class FimaFeng implements ModCreature, CreatureTypes {
    ...
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        ...
        CreatureTemplateBuilder builder = new CreatureTemplateBuilder("mod.creature.FimaFeng", "FimaFeng", "The Might Ocean Giants loyal bartender.",
                "model.creature.humanoid.human.bartender", types, BodyTemplate.TYPE_HUMAN, (short) 2, (byte) 0, (short) 85, (short) 50, (short) 85,
                "sound.death.giant", "sound.death.giant", "sound.combat.hit.giant", "sound.combat.hit.giant",
                0.05f, 30f, 15f, 0f, 0.0f, 25.0f, 0.7f, 300,
        ...
        builder.setCombatMoves(new int[] { 1, 2 });
