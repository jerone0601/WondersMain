 ...
 */
public class DaughterOfAegir implements ModCreature, CreatureTypes {
    ...
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        ...
        CreatureTemplateBuilder builder = new CreatureTemplateBuilder("mod.creature.daughterofaegir", "Daughter of the Sea", "Daughter of the Sea.",
                "model.creature.humanoid.human.salesman.female", types, BodyTemplate.TYPE_ETTIN, (short) 2, (byte) 0, (short) 85, (short) 50, (short) 85,
                "sound.death.giant", "sound.death.giant", "sound.combat.hit.giant", "sound.combat.hit.giant",
                0.09f, 19f, 15f, 0f, 0.0f, 25.0f, 0.7f, 300,
        ...
        builder.baseCombatRating(38.0f);
