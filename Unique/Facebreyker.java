...
public class Facebreyker implements ModCreature, CreatureTypes {
	...
	public CreatureTemplateBuilder createCreateTemplateBuilder() {
		...
		CreatureTemplateBuilder builder = new CreatureTemplateBuilder("mod.creature.unique.facebreyker", "Corrupted Skadi", "A bold warrior corrupted by darkness.",
				"model.creature.humanoid.ogre.rift", types, BodyTemplate.TYPE_ETTIN, (short) 20, (byte) 0, (short) 350, (short) 100, (short) 60,
				...
				new int[]{ItemList.boneCollar, ItemList.skull}, 40, 100, (byte) 0);
		...
		builder.setCombatMoves(new int[] { 1, 2, 4, 7 });
