 ...
 */
public class RansDagger implements ItemTypes, MiscConstants {
    public static Logger logger = Logger.getLogger(Eviscerator.class.getName());
    public static int templateId;
    private String name = "Ran's dagger";
    ...
    public void createTemplate() throws IOException {
		 ...
		 */
        ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.ransdagger");
        itemBuilder.name(name, "Rans daggers", "A deadly dagger stained by the blood of many sailors.");
