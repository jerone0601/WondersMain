 ...
 */
public class Andvaranaut implements ItemTypes, MiscConstants {
    public static Logger logger = Logger.getLogger(Knuckles.class.getName());
    public static int templateId;
    private String name = "Andavaranaut";
    ...
    public void createTemplate() throws IOException {
		 ...
		 */
        ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.andvaranaut");
        itemBuilder.name(name, "Andavaranaut", "A cursed ring large and deadly enough to use as a hand to hand weapon.");
    ...
    public void initCreationEntry(){
        ...
        if(templateId > 0){
            ...
            CreationEntryCreator.createSimpleEntry(SkillList.GROUP_SMITHING_WEAPONSMITHING, RansDagger.templateId, FafnirsBackSpike.templateId,
