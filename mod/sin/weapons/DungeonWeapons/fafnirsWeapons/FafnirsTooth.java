...
import mod.sin.weapons.DungeonWeapons.FrostiPuppet;
 ...
 */
public class FafnirsTooth implements ItemTypes, MiscConstants {
    public static Logger logger = Logger.getLogger(Eviscerator.class.getName());
    public static int templateId;
    private String name = "Fafnir's Tooth";
    public void createTemplate() throws IOException {
		 ...
		 */
        ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.fafnirstooth");
        itemBuilder.name(name, "Fafnirs Teeth", "A tooth from the legendary dragon Fafnir that could be wielded as a long sword by a capable swordsman.");
        ...
        itemBuilder.imageNumber((short) 1224);
        itemBuilder.behaviourType((short) 35);
        itemBuilder.combatDamage(40);
        itemBuilder.decayTime(Long.MAX_VALUE);
        itemBuilder.dimensions(5, 10, 80);
        itemBuilder.primarySkill(SkillList.SWORD_LONG);
        itemBuilder.bodySpaces(MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY);
        itemBuilder.modelName("model.weapon.swordlong.adamantine");
    ...
    public void initCreationEntry(){
        ...
        if(templateId > 0){
            ...
            CreationEntryCreator.createSimpleEntry(SkillList.GROUP_SMITHING_WEAPONSMITHING, AegirClub.templateId, FafnirsBackSpike.templateId,
