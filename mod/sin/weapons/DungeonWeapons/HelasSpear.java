 ...
 */
public class HelasSpear implements ItemTypes, MiscConstants {
    public static Logger logger = Logger.getLogger(Eviscerator.class.getName());
    public static int templateId;
    private String name = "Hela's Spear";
    ...
    public void createTemplate() throws IOException {
		 ...
		 */
        ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.helaSpear");
        itemBuilder.name(name, "Hela's Spears", "A spear stained with the blood of the innocent.");
        ...
        itemBuilder.imageNumber((short) 1221);
        ...
        itemBuilder.modelName("model.weapon.polearm.spear.glimmersteel");
    ...
    public void initCreationEntry(){
        ...
        if(templateId > 0){
            ...
            CreationEntryCreator.createSimpleEntry(SkillList.CARPENTRY_FINE, AegirClub.templateId, NarvisHalberd.templateId,
