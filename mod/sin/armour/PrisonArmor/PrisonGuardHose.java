 ...
 */
public class PrisonGuardHose implements ItemTypes, MiscConstants {
    public static Logger logger = Logger.getLogger(PrisonGuardHose.class.getName());
    public static int templateId;
    private String name = "Prison Guard Leggings";
    public void createTemplate() throws IOException {
		 ...
		 */
        ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.prisonguardhose");
        itemBuilder.name(name, "prison guard leggings", "A set of ringmail hose made for Life Spring Guards.");
    ...
    public void initCreationEntry(){
        ...
        if(templateId > 0){
            ...
            CreationEntryCreator.createSimpleEntry(SkillList.SMITHING_ARMOUR_CHAIN, PrisonGuardVest.templateId, PrisonGuardCoif.templateId,
