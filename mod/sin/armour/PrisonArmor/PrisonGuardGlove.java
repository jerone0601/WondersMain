 ...
 */
public class PrisonGuardGlove implements ItemTypes, MiscConstants {
    public static Logger logger = Logger.getLogger(PrisonGuardGlove.class.getName());
    public static int templateId;
    private String name = "Prison Guard Glove";
    public void createTemplate() throws IOException {
		 ...
		 */
        ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.prisonguardglove");
        itemBuilder.name(name, "prison guard gloves", "A ringmail glove made for Life Spring Guards.");
    ...
    public void initCreationEntry(){
        ...
        if(templateId > 0){
            ...
            CreationEntryCreator.createSimpleEntry(SkillList.SMITHING_ARMOUR_CHAIN, PrisonGuardSleeve.templateId, PrisonGuardBoot.templateId,
