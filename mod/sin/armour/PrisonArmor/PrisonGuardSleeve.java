 ...
 */
public class PrisonGuardSleeve implements ItemTypes, MiscConstants {
    public static Logger logger = Logger.getLogger(PrisonGuardSleeve.class.getName());
    public static int templateId;
    private String name = "Prison Guard Sleeve";
    public void createTemplate() throws IOException {
		 ...
		 */
        ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.PrisonGuardSleeve");
        itemBuilder.name(name, "prison guard sleeves", "A Life Spring Prison guard's ringmail sleeve.");
    ...
    public void initCreationEntry(){
        ...
        if(templateId > 0){
            ...
            CreationEntryCreator.createSimpleEntry(SkillList.SMITHING_ARMOUR_CHAIN, PrisonGuardBoot.templateId, PrisonGuardBoot.templateId,
