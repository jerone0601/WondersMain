 ...
 */
public class PrisonGuardVest implements ItemTypes, MiscConstants {
    public static Logger logger = Logger.getLogger(PrisonGuardVest.class.getName());
    public static int templateId;
    private String name = "Prison Guard Jacket";
    public void createTemplate() throws IOException {
		 ...
		 */
        ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.prisonguardvest");
        itemBuilder.name(name, "prison guard jackets", "A ringmail jacket created for the guards of Life Spring Prison");
    ...
    public void initCreationEntry(){
        ...
        if(templateId > 0){
            ...
            CreationEntryCreator.createSimpleEntry(SkillList.SMITHING_ARMOUR_CHAIN, PrisonGuardHose.templateId, PrisonGuardHose.templateId,
