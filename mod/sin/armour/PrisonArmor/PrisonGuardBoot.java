 ...
 */
public class PrisonGuardBoot implements ItemTypes, MiscConstants {
    public static Logger logger = Logger.getLogger(PrisonGuardBoot.class.getName());
    public static int templateId;
    private String name = "Prison Guard Boot";
    public void createTemplate() throws IOException {
		 ...
		 */
        ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.Prisonguardboot");
        itemBuilder.name(name, "Prison Guard Boots", "Ringmail boot made for Life Spring Prison Guards.");
    ...
    public void initCreationEntry(){
        ...
        if(templateId > 0){
            ...
            CreationEntryCreator.createSimpleEntry(SkillList.SMITHING_ARMOUR_CHAIN, PrisonGuardSleeve.templateId, PrisonGuardGlove.templateId,
