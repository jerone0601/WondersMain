 ...
 */
public class GiantFireHose implements ItemTypes, MiscConstants {
    public static Logger logger = Logger.getLogger(GiantFireHose.class.getName());
    public static int templateId;
    private String name = "Giant Fire Leggings";
    public void createTemplate() throws IOException {
		 ...
		 */
        ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.giantsfirehose");
        itemBuilder.name(name, "Giant Fire leggings", "A ringmail jacket created by fire giants for there human allies.");
    ...
    public void initCreationEntry(){
        ...
        if(templateId > 0){
            ...
            CreationEntryCreator.createSimpleEntry(SkillList.SMITHING_ARMOUR_CHAIN, GiantFireJacket.templateId, GiantFireCoif.templateId,
