package mod.sin.armour.JotDungeonArmor;
...
/**
 * Created by Jerone on 11/7/2017.
 */
public class GiantFireSleeve implements ItemTypes, MiscConstants {
    public static Logger logger = Logger.getLogger(GiantFireSleeve.class.getName());
    public static int templateId;
    private String name = "Giant Fire Sleeve";
    public void createTemplate() throws IOException {
		 ...
		 */
        ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.GiantFireSleeve");
        itemBuilder.name(name, "Giant Fire Sleeves", "A ringmail sleeve created by fire giants for there human allies.");
    ...
    public void initCreationEntry(){
        ...
        if(templateId > 0){
            ...
            CreationEntryCreator.createSimpleEntry(SkillList.SMITHING_ARMOUR_CHAIN, GiantFireBoot.templateId, GiantFireGlove.templateId,
