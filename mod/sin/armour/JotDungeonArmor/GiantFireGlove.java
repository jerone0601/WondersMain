 ...
 */
public class GiantFireGlove implements ItemTypes, MiscConstants {
    public static Logger logger = Logger.getLogger(GiantFireGlove.class.getName());
    public static int templateId;
    private String name = "Giant Fire Glove";
    public void createTemplate() throws IOException {
		 ...
		 */
        ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.giantfireglove");
        itemBuilder.name(name, "giant fire gloves", "A ringmail glove created by fire giants for there human allies.");
    ...
    public void initCreationEntry(){
        ...
        if(templateId > 0){
            ...
            CreationEntryCreator.createSimpleEntry(SkillList.SMITHING_ARMOUR_CHAIN, GiantFireSleeve.templateId, GiantFireBoot.templateId,
