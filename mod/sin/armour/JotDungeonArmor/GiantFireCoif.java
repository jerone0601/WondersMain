 ...
 */
public class GiantFireCoif implements ItemTypes, MiscConstants {
    public static Logger logger = Logger.getLogger(GiantFireCoif.class.getName());
    public static int templateId;
    private String name = "Giant Fire Coif";
    public void createTemplate() throws IOException {
		 ...
		 */
        ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.giantfirecoif");
        itemBuilder.name(name, "Giant Fire Coifs", "A ringmail coif created by fire giants for there human allies.");
