 ...
 */
public class GiantFireJacket implements ItemTypes, MiscConstants {
    public static Logger logger = Logger.getLogger(GiantFireJacket.class.getName());
    public static int templateId;
    private String name = "Giant Fire Jacket";
    public void createTemplate() throws IOException {
		 ...
		 */
        ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.giantsfirevest");
        itemBuilder.name(name, "Giant Fire jackets", "A ringmail jacket created by fire giants for there human allies.");
    ...
    public void initCreationEntry(){
        ...
        if(templateId > 0){
            ...
            CreationEntryCreator.createSimpleEntry(SkillList.SMITHING_ARMOUR_CHAIN, GiantFireHose.templateId, GiantFireHose.templateId,
