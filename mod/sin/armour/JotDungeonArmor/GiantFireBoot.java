 ...
 */
public class GiantFireBoot implements ItemTypes, MiscConstants {
    public static Logger logger = Logger.getLogger(GiantFireBoot.class.getName());
    public static int templateId;
    private String name = "Giant Fire Boot";
    public void createTemplate() throws IOException {
		 ...
		 */
        ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.giantfireboot");
        itemBuilder.name(name, "Giant Fire Boots", "A ringmail boot created by fire giants for there human allies.");
    ...
    public void initCreationEntry(){
        ...
        if(templateId > 0){
            ...
            CreationEntryCreator.createSimpleEntry(SkillList.SMITHING_ARMOUR_CHAIN, GiantFireGlove.templateId, GiantFireGlove.templateId,
