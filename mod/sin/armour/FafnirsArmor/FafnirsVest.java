...
import mod.sin.armour.GlimmerScale.GlimmerscaleVest;
 ...
 */
public class FafnirsVest implements ItemTypes, MiscConstants {
    public static Logger logger = Logger.getLogger(GlimmerscaleVest.class.getName());
    public static int templateId;
    private String name = "Fafnir Scale Jacket";
    public void createTemplate() throws IOException {
		 ...
		 */
        ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.fafnirsVest");
        itemBuilder.name(name, "Fafnir Scale Jackets", "Jacket made from scales of the legendary dragon Fafnir.");
