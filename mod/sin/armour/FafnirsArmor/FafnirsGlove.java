...
import mod.sin.armour.GlimmerScale.GlimmerscaleGlove;
 ...
 */
public class FafnirsGlove implements ItemTypes, MiscConstants {
    public static Logger logger = Logger.getLogger(GlimmerscaleGlove.class.getName());
    public static int templateId;
    private String name = "Fafnir Scale Glove";
    public void createTemplate() throws IOException {
		 ...
		 */
        ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.fafnirsglove");
        itemBuilder.name(name, "Fafnir Scale Gloves", "Gloves made from scales of the legendary dragon Fafnir.");
