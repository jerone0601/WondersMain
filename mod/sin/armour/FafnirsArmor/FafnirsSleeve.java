...
import mod.sin.armour.GlimmerScale.GlimmerscaleSleeve;
 ...
 */
public class FafnirsSleeve implements ItemTypes, MiscConstants {
    public static Logger logger = Logger.getLogger(GlimmerscaleSleeve.class.getName());
    public static int templateId;
    private String name = "Fafnir Scale Sleeve";
    public void createTemplate() throws IOException {
		 ...
		 */
        ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.fafnirssleeve");
        itemBuilder.name(name, "Fafinr Scale Sleeves", "Sleeves made from scales of the legendary dragon Fafnir.");
