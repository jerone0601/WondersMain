...
import mod.sin.armour.GlimmerScale.GlimmerscaleHose;
 ...
 */
public class FafnirsHose implements ItemTypes, MiscConstants {
    public static Logger logger = Logger.getLogger(GlimmerscaleHose.class.getName());
    public static int templateId;
    private String name = "Fafnir Scale Leggings";
    public void createTemplate() throws IOException {
		 ...
		 */
        ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.fafnirsHose");
        itemBuilder.name(name, "Fafnir Scale Leggings", "Leggings made from scales of legendary dragon Fafnir.");
    ...
    public void initCreationEntry(){
        ...
        if(templateId > 0){
            ...
            CreationEntryCreator.createSimpleEntry(SkillList.SMITHING_ARMOUR_PLATE, FafnirScale.templateId, SpectralHide.templateId,
