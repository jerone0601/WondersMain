...
/**
 * Created by Jerone on 10/23/2017.
 */
public class GhostDrake implements ModCreature, CreatureTypes {
    ...
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        ...
        CreatureTemplateBuilder builder = new CreatureTemplateBuilder("mod.creature.ghost.drake", "Zomok", "A ghost of a mighty dragon.",
                ...
                Servers.localServer.PVPSERVER ? 0.65f : 0.35f, 90.0f, 93.0f, 0.0f, 0.0f, 0.0f, 2.5f, 800,
        ...
        builder.skill(SkillList.MIND_LOGICAL, 90.0f);
        ...
        builder.baseCombatRating(98.0f);
