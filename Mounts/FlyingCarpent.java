...
/**
 * Created by Jerone on 11/13/2017.
 */
public class FlyingCarpent implements ModCreature, CreatureTypes {
    ...
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        ...
        CreatureTemplateBuilder builder = new CreatureTemplateBuilder("mod.creature.flyingcarpet", "Magic Carpet", "Magic Cart Ride.",
                "model.decoration.carpet.medi.two", types, BodyTemplate.TYPE_DOG, (short) 5, (byte) 0, (short) 85, (short) 50, (short) 85,
                "sound.death.dog", "sound.death.dog", "sound.combat.hit.dog", "sound.combat.hit.dog",
                Servers.localServer.PVPSERVER ? 0.75f : 0.4f, 17f, 13f, 15.0f, 0.0f, 0.0f, 2.2f, 500,
    ...
    public ModVehicleBehaviour getVehicleBehaviour() {
        ...
        return new ModVehicleBehaviour() {
            ...
            public void setSettingsForVehicle(Creature creature, Vehicle v) {
                ...
                vehicle.setMaxHeightDiff(0.98f);
                vehicle.setMaxDepth(-1.7f);
                vehicle.setMaxSpeed(54.0f);
