...
/**
 * Created by Jerone on 11/19/2017.
 */
public class GiantTortoise implements ModCreature, CreatureTypes {
    ...
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        ...
        CreatureTemplateBuilder builder = new CreatureTemplateBuilder("mod.creature.GiantTortoise", "Giant Tortoise", "A strong tortoise capable of being hitched to your cart or wagon.",
                "model.creature.quadraped.tortoise", types, (byte) BodyTemplate.TYPE_HUMAN, (short) 5, (byte) 0, (short) 85, (short) 50, (short) 85,
                "sound.death.snake", "sound.death.snake", "sound.combat.hit.snake", "sound.combat.hit.snake",
                0.1f, 8f, 0f, 10.0f, 14.0f, 0.0f, 1.6f, 500,
                new int[]{ItemList.fur, ItemList.heart}, 10, 74, Materials.MATERIAL_MEAT_TOUGH);
