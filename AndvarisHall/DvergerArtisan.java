 ...
 */
public class DvergerArtisan implements ModCreature, CreatureTypes {
    ...
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        ...
        CreatureTemplateBuilder builder = new CreatureTemplateBuilder("mod.creature.dvergerArtisan", "Dvergr Artisan", "Mastersmith lead by Andvari",
                ...
                0.1f, 22f, 0f, 15f, 0.0f, 15.0f, 0.7f, 300,
        ...
        builder.setCombatMoves(new int[] { 1, 10 });
