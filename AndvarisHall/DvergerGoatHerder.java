 ...
 */
public class DvergerGoatHerder implements ModCreature, CreatureTypes {
    ...
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        ...
        CreatureTemplateBuilder builder = new CreatureTemplateBuilder("mod.creature.DvergerHerder", "Goat Herder", "Dvergr herder of prized goats",
                ...
                0.3f, 19f, 0f, 0f, 0.0f, 15.0f, 0.7f, 300,
        ...
        builder.setCombatMoves(new int[] { 2, 1 });
