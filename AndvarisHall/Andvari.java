 ...
 */
public class Andvari implements ModCreature, CreatureTypes {
    ...
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        ...
        CreatureTemplateBuilder builder = new CreatureTemplateBuilder("mod.creature.Andvari", "Andvari", "The Master Smith. Angered by Loki and no longer accepting visitors",
                "model.creature.humanoid.goblin.leader", types, BodyTemplate.TYPE_HUMAN, (short) 5, (byte) 0, (short) 85, (short) 50, (short) 85,
        ...
        builder.setCombatMoves(new int[] { 1, 2, 10, 4 });
