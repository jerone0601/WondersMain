 ...
 */
public class TrollDummyTwo implements ModCreature, CreatureTypes {
    ...
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        ...
        CreatureTemplateBuilder builder = new CreatureTemplateBuilder("mod.creature.trolldummytwo", "TD Two", "A practice dummy with chain armor.",
