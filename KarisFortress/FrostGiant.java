 ...
 */
public class FrostGiant implements ModCreature, CreatureTypes {
    ...
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        ...
        CreatureTemplateBuilder builder = new CreatureTemplateBuilder("mod.creature.frostgiant", "Frost Giant", "A frost giant who loves the tastes of human flesh.",
                "model.creature.humanoid.lavacreature", types, BodyTemplate.TYPE_ETTIN, (short) 5, (byte) 0, (short) 85, (short) 50, (short) 85,
        ...
        builder.maxAge(100);
        builder.armourType(ArmourTypes.ARMOUR_RING);
