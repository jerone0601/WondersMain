 ...
 */
public class TinyBlue implements ModCreature, CreatureTypes {
    ...
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        ...
        //       final int[] itemsButcheblue, final int maxHuntDist, final int aggress) {
        CreatureTemplateBuilder builder = new CreatureTemplateBuilder("mod.creature.tinyblue", "Blue Dragonling", "A small dragonling.",
                "model.creature.drake.blue", types, BodyTemplate.TYPE_DOG, (short) 10, (byte) 1, (short) 350, (short) 100, (short) 60,
