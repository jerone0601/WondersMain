 ...
 */
public class TinyBlack implements ModCreature, CreatureTypes {
    ...
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        ...
        //       final int[] itemsButcheblack, final int maxHuntDist, final int aggress) {
        CreatureTemplateBuilder builder = new CreatureTemplateBuilder("mod.creature.TinyBlack", "Black Dragonling", "A small dragonling.",
                "model.creature.drake.black", types, BodyTemplate.TYPE_DOG, (short) 10, (byte) 1, (short) 350, (short) 100, (short) 60,
