...
/**
 * Created by Jerone on 11/2/2017.
 */
public class GoblinScout implements ModCreature, CreatureTypes {
    ...
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        ...
        CreatureTemplateBuilder builder = new CreatureTemplateBuilder("mod.creature.humanoid.goblinscout", "Goblin Scout", "Highly trained scout from the goblin citadel",
                "model.creature.humanoid.goblin", types, BodyTemplate.TYPE_HUMAN, (short) 10, (byte) 0, (short) 85, (short) 50, (short) 85,
                "sound.death.goblin", "sound.death.goblin", "sound.combat.hit.goblin", "sound.combat.hit.goblin",
                0.1f, 25f, 0f, 15.0f, 0.0f, 0.0f, 1.2f, 1500,
