 ...
 */
public class EscapedPrisoner implements ModCreature, CreatureTypes {
    ...
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        ...
        // int[] types = new int[]{7, 6, 13, 3, 29, 39, 60, 61}; - male
        int[] types = {
        ...
        CreatureTemplateBuilder builder = new CreatureTemplateBuilder("mod.creature.escapedprisoner", "Escaped Prisoner", "A prisoner that has escaped Life Spring prison.",
                "model.creature.humanoid.human.guide.male.free.", types, BodyTemplate.TYPE_HUMAN, (short) 5, (byte) 0, (short) 85, (short) 50, (short) 85,
                "sound.death.male", "sound.death.male", "sound.combat.hit.male", "sound.combat.hit.male",
                0.8f, 5f, 0f, 10.0f, 0.0f, 0.0f, 1.2f, 500,
