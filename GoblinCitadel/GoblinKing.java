 ...
 */
public class GoblinKing implements ModCreature, CreatureTypes {
    ...
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        ...
        CreatureTemplateBuilder builder = new CreatureTemplateBuilder("mod.creature.goblinKing", "Goblin King", "King of the Goblins.",
                "model.creature.humanoid.goblin.leader", types, BodyTemplate.TYPE_HUMAN, (short) 2, (byte) 0, (short) 85, (short) 50, (short) 85,
                ...
                new int[]{ItemList.heart, ItemList.eye, ItemList.gland}, 15, 70, Materials.MATERIAL_MEAT_TOUGH);
