 ...
 */
public class GoblinMiner implements ModCreature, CreatureTypes {
    ...
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        ...
        CreatureTemplateBuilder builder = new CreatureTemplateBuilder("mod.creature.goblinminer", "Goblin Miner", "Greedy goblin miner.",
                ...
                0.2f, 15f, 0f, 15.0f, 0.0f, 0.0f, 1.2f, 500,
        ...
        builder.handDamString("whack");
        builder.maxAge(100);
        builder.armourType(ArmourTypes.ARMOUR_CHAIN);
        builder.baseCombatRating(33.0f);
