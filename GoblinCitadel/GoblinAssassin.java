 ...
 */
public class GoblinAssassin implements ModCreature, CreatureTypes {
    ...
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        ...
        CreatureTemplateBuilder builder = new CreatureTemplateBuilder("mod.creature.goblinassassin", "Goblin Assassin", "Deadly assassin of the Goblin Army.",
