 ...
 */
public class CaptainFrank implements ModCreature, CreatureTypes {
    ...
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        ...
        CreatureTemplateBuilder builder = new CreatureTemplateBuilder("mod.creature.captainfrank", "Captain Frank", "Captain of the deserter army.",
                ...
                0.4f, 15f, 15f, 10.0f, 0.0f, 0.0f, 1.2f, 500,
